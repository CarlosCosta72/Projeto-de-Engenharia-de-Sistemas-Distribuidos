...
- Este repositório tem como objetivo: provar que a geração de desafios por IA pode ser desacoplada do fluxo crítico, operando como
pool assíncrono com fallback para banco estático.
